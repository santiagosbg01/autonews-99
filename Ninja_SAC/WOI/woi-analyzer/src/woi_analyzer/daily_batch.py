"""Job principal del batch diario: clasifica con Sonnet + reconstruye incidents + genera reporte."""
...
from woi_analyzer.db import fetch_daily_report_input, insert_daily_report
